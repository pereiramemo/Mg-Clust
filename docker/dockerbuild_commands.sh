...
docker build --network=host -f ${SCRIPT_DIR}/Dockerfile.module-3 -t ghcr.io/epereira/mg-clust/module-3:latest .
docker build --network=host -f ${SCRIPT_DIR}/Dockerfile.module-4 -t ghcr.io/epereira/mg-clust/module-4:latest .
