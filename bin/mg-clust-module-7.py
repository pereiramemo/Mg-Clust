#!/usr/bin/env python3
"""
mg-clust module 7: Merge taxonomy, function, and abundance tables.

Assumes execution inside the conda environment "mg-clust-module-7" (or equivalent)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="mg-clust module 7", add_help=False)
...
def main() -> None:
    ...
    print("mg-clust_module-7.py exited successfully")
    sys.exit(0)
